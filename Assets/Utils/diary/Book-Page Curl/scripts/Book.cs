...
public class Book : MonoBehaviour {
    ...
    public Text diaryLeft, diaryRight;
    public string[] diaryLeftContent, diaryRightContent;
    ...
    void Start()
    {
        ...
        diaryLeft.text = diaryLeftContent[0];
        diaryRight.text = diaryRightContent[0];
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        now++;
        diaryLeft.text = diaryLeftContent[now];
        diaryRight.text = diaryRightContent[now];
        Debug.Log(now);
